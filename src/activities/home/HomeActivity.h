...
class HomeActivity final : public Activity {
  ...
  static int menuItemToIndex(HomeMenuItem item, bool hasOpdsUrl) {
    ...
    ++i;
    if (item == HomeMenuItem::COMPANION) return i;
    return 0;
  }
  ...
  static HomeMenuItem indexToMenuItem(int idx, bool hasOpdsUrl) {
    ...
    if (idx == i) return HomeMenuItem::COMPANION;
  ...
  void onCompanionOpen();  // placeholder entry point for X3 companion-platform work
